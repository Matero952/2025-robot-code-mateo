    ...
    private void configureBindings() {
        ...
        swerveSubsystem.setDefaultCommand(
                new DriveCommands(
                        ...
                        true,
                        true));
        primaryController.dpadDown.whileTrue(
                new ClimberCommand(climberSubsystem, primaryController));
        primaryController.dpadUp.whileTrue(new ClimberCommand(climberSubsystem, primaryController));
        primaryController.dpadLeft.whileTrue(
                new ClimberCommand(climberSubsystem, primaryController));
        ...
        //
        //        //        primaryController.bButton.whileTrue(new
        // ElevatorPositionCommand(elevatorSubsystem,
        //        // 0.3));
        //
        ...
        //        //        primaryController.aButton.whileTrue(new
        // ReefAlignCommand(swerveSubsystem));
